    ...
    return (
        <>
            <div className="bg-gray-900 h-screen">
                <section className="bg-gray-900 dark:bg-gray-900 flex justify-center ">
                    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                        <div className="mr-auto place-self-center lg:col-span-7">
                            ...
                            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                                Manage your tasks effortlessly with our intuitive and user-friendly todo list app. Keep track of your to-dos, set priorities, and achieve your goals with ease.
                            </p>
